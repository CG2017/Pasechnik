...
namespace lab1
{
    ...
    internal class CmykProfileConverter
    {
        ...
        [DllImport("mscms.dll", SetLastError = true, EntryPoint = "OpenColorProfileW",
        ...
        [DllImport("mscms.dll", SetLastError = true, EntryPoint = "GetStandardColorSpaceProfileW",
            CallingConvention = CallingConvention.Winapi)]
        ...
        {
            internal readonly ushort cyan;
            internal readonly ushort magenta;
            internal readonly ushort yellow;
            internal readonly ushort black;
        }
        ...
        {
            [MarshalAs(UnmanagedType.LPTStr)] internal readonly string profileData;
