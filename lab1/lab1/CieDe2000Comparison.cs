...
namespace lab1
{
    ...
    public class CieDe2000Comparison : IColorSpaceComparison
    {
        ...
        public double Compare(IColorSpace c1, IColorSpace c2)
        {
            ...
            var G = 0.5d*(1 - Math.Sqrt(c_star_average_ab_pot7/(c_star_average_ab_pot7 + 6103515625))); //25^7
            ...
            //Angles in Degree.
            var h_prime_1 = (Math.Atan2(lab1.B, a1_prime)*180d/Math.PI + 360)%360d;
            var h_prime_2 = (Math.Atan2(lab2.B, a2_prime)*180d/Math.PI + 360)%360d;
            ...
            var delta_H_prime = 2*Math.Sqrt(C_prime_1*C_prime_2)*Math.Sin(delta_h_prime*Math.PI/360d);

            // Calculate CIEDE2000
            var L_prime_average = (lab1.L + lab2.L)/2d;
            var C_prime_average = (C_prime_1 + C_prime_2)/2d;
            ...
            var S_L = 1 + .015d*L_prime_average_minus_50_square/Math.Sqrt(20 + L_prime_average_minus_50_square);
            var S_C = 1 + .045d*C_prime_average;
            var T = 1
